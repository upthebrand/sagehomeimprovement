...
export const termsParagraphs = [
	'These placeholder terms of use govern your use of this website. Replace with your final terms before launch.',
	'Estimates and proposals are subject to on-site verification, product availability, and written agreement. Nothing on this site constitutes a binding contract until you and Sage Home Improvements have mutually executed an agreement.',
	'For service or warranty questions, reach out using the contact information in the footer.',
];
